          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Convierte a la Piña Gota Miel Kg en el ingrediente principal de tu cocina. Ya sea en bebidas, postres, aperitivos o guisados, esta fruta le dará un toque de dulzura y acides a tus platillos favoritos.',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
                        color: FlutterFlowTheme.of(context).secondaryText,
                      ),
