...
class CerealWidget extends StatefulWidget {
  const CerealWidget({Key key}) : super(key: key);

  @override
  _CerealWidgetState createState() => _CerealWidgetState();
}

class _CerealWidgetState extends State<CerealWidget> {
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Cereal Kellogg\'s Froot Loops 90g',
              ...
              Padding(
                ...
                child: Text(
                  'Kellogg´s Froot Loops Deliciosos aritos elaborados con tres diferentes cereales: maíz, trigo y avena; sus sabores naturales a frutas lo hacen frutidivertido. Acompáñalos con leche y fruta para el desayuno o la cena, o disfrútalos como un snack. ',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
