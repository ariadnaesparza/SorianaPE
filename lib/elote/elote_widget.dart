...
class EloteWidget extends StatefulWidget {
  const EloteWidget({Key key}) : super(key: key);

  @override
  _EloteWidgetState createState() => _EloteWidgetState();
}

class _EloteWidgetState extends State<EloteWidget> {
          ...
          child: Column(
            ...
            children: [
                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(10, 10, 10, 10),
                        child: Text(
                          'Selecciona el grado de maduración',
                          style:
              ...
              Padding(
                ...
                child: Text(
                  '¿Qué sería de la gastronomía mexicana sin antojitos como los esquites? No importa con qué ingredientes decidas acompañarlos, siempre será una buena opción agregar el Elote Blanco a tus platillos favoritos, puedes combinarlos con arroz, con una crema o sopa, e inclusive servirlos solos con mantequilla como guarnición.',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
                        color: FlutterFlowTheme.of(context).secondaryText,
                      ),
