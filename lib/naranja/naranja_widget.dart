...
class NaranjaWidget extends StatefulWidget {
  const NaranjaWidget({Key key}) : super(key: key);

  @override
  _NaranjaWidgetState createState() => _NaranjaWidgetState();
}

class _NaranjaWidgetState extends State<NaranjaWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'La forma más común de consumir la Naranja Kg es en un jugo recién hecho. Además de ser un antioxidante natural, su alto valor en vitaminas y minerales la convierte en una opción para tener vitamina C y reforzar las defensas.',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
                        color: FlutterFlowTheme.of(context).secondaryText,
                      ),
