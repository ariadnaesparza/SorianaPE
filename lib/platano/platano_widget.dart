...
class PlatanoWidget extends StatefulWidget {
  const PlatanoWidget({Key key}) : super(key: key);

  @override
  _PlatanoWidgetState createState() => _PlatanoWidgetState();
}

class _PlatanoWidgetState extends State<PlatanoWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'El Plátano Kg se ha vuelto indispensable en la dieta de todo México y es uno de los productos de mayor producción en el sureste de nuestro país. Debido a su fuente rica en minerales, textura suave y sabor dulce, el plátano se puede consumir solo o tomarlo como ingrediente para el sector de la repostería.',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
                        color: FlutterFlowTheme.of(context).secondaryText,
                      ),
