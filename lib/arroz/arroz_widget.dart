...
class ArrozWidget extends StatefulWidget {
  const ArrozWidget({Key key}) : super(key: key);

  @override
  _ArrozWidgetState createState() => _ArrozWidgetState();
}

class _ArrozWidgetState extends State<ArrozWidget> {
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.network(
                        'https://github.com/ariadnaesparza/imagenes_soriana/blob/main/arroz.jpg?raw=truehttps://github.com/ariadnaesparza/imagenes_soriana/blob/main/arroz.jpg?raw=tru',
                        width: 350,
                        height: 200,
                        fit: BoxFit.contain,
                      ),
