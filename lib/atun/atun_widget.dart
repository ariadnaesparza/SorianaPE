...
class AtunWidget extends StatefulWidget {
  const AtunWidget({Key key}) : super(key: key);

  @override
  _AtunWidgetState createState() => _AtunWidgetState();
}

class _AtunWidgetState extends State<AtunWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Con toda confianza, es Herdez. Prepara las más ricas croquetas, o que tal una ensalada con él Atún Herdez en agua 130 g y disfruta nuestra familia de productos está compuesta por alimentos frescos que no deben faltar en tu despensa. Prepara los más deliciosos platillos y delita a tu familia. ',
                  style: FlutterFlowTheme.of(context).bodyText1.override(
                        fontFamily: 'Poppins',
